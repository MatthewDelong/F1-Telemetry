...
precacheAndRoute([{
  ...
  "url": "index.html",
  "revision": "0.abq99akd60c"
}], {});
cleanupOutdatedCaches();
registerRoute(new NavigationRoute(createHandlerBoundToURL("index.html"), {
  allowlist: [/^\/$/],
  denylist: [/^\/openf1/, /^https:\/\/(www|region1)\.google-analytics\.com/, /^https:\/\/www\.googletagmanager\.com/]
}));
registerRoute(/^https:\/\/(www|region1)\.google-analytics\.com\/.*/i, new NetworkOnly(), 'GET');
registerRoute(/^https:\/\/www\.googletagmanager\.com\/.*/i, new NetworkOnly(), 'GET');
registerRoute(/\.(?:png|jpg|jpeg|svg|webp|ico|glb|bin)$/, new StaleWhileRevalidate({
