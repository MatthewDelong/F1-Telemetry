...
export function RacePageF1a({ championshipLevel }) {
  ...
  const fastestRace3DriverCode = getFastestDriverCode(raceResults3);
    ...
    <div className="standard-scroll-container">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        {raceResults0.length > 0 && (
          <div className="flex flex-col items-center flex-1 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 p-32">
                ...
                <DriverCard
                  ...
                  fastestLap={{
                    ...
                    rank:
                      ...
                      (result.Driver?.code === fastestRace0DriverCode
                        ? "1"
                        : undefined),
                  }}
                  layoutSmall={index > 2}
            ...
            <div className="page-container-centered">
              <FastestLapsF1A raceResults={raceResults0} drivers={drivers} />
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col items-center flex-1 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 p-32">
          ...
          <div className="page-container-centered">
            <FastestLapsF1A raceResults={raceResults} drivers={drivers} />
          </div>
        </div>
        ...
        {raceResults2.length > 0 && (
          <div className="flex flex-col items-center flex-1 bg-gradient-to-br from-pink-500/10 via-purple-500/10 to-indigo-500/10 p-32">
            ...
            <div className="page-container-centered">
              <FastestLapsF1A raceResults={raceResults2} drivers={drivers} />
            </div>
          </div>
        )}
              ...
              {raceResults3.map((result, index) => (
                <DriverCard
                  ...
                  fastestLap={{
                    ...
                    rank:
                      result.FastestLap?.rank ??
                      (result.Driver?.code === fastestRace3DriverCode
                        ? "1"
                        : undefined),
                  }}
                  layoutSmall={index > 2}
