...
export function RacePageF2({ championshipLevel }) {
  ...
  return (
    <div className="standard-scroll-container">
      ...
      <div className="flex flex-col md:flex-row justify-center">
        {/* race 1 */}
        <div className="flex flex-col items-center md:w-1/2 bg-gradient-to-br from-[#023358] to-[#012845] p-64">
          <p className="heading-2 mb-32">Sprint Race</p>
