...
export function RacePage() {
    ...
    useEffect(() => {
        const fetchByMeetingKey = async () => {
            ...
            setLocation(response[raceId]["location"] ? response[raceId]["location"].toLowerCase() : null);
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (!Array.isArray(sessionsData)) {
                console.error("Failed to fetch sessions data (not an array):", sessionsData);
                setIsLoading(false);
                return;
            }
    ...
    const isAnimatedLocation = location && animatedLocations.includes(location.toLowerCase());
