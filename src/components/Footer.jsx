  ...
  return (
    <div
      className={classNames(
        "footer flex justify-center flex-col bg-glow bg-glow-large px-16 p-32 mt-64",
        className,
      )}
    >
      <div className="flex flex-col justify-center">
        <p className="tracking-sm text-neutral-400 text-sm text-center md:mt-16 mb-16">
          Creators
        </p>
        <div className="flex max-md:flex-col max-md:items-center md:justify-center gap-32">
          <ConstructorDriver
            ...
            points={
              <div className="flex item-center">
                <a
                  href="https://www.linkedin.com/in/antonicommodore/"
                  className="icon-link"
          ...
          <ConstructorDriver
            ...
            points={
              <div className="flex item-center">
                <a
                  href="https://www.linkedin.com/in/mani-praneeth-chilukuri-a099a21ba/"
                  className="icon-link"
                  style={{ marginLeft: "10px" }}
                >
                  <FaLinkedin size={24} />
      ...
      <div className="flex flex-col items-center gap-2 md:text-right mt-32">
        <p className="tracking-sm text-neutral-400 text-sm">
          Enjoy our work? Follow us here:
        </p>
