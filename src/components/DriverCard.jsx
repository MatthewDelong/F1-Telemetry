...
export const DriverCard = (props) => {
  ...
  const driverImage = (
    <img
      ...
      ref={ref}
      className={classNames(
        "absolute block inset-x-0 bottom-[0px]",
        championshipLevel === "F2"
          ? "left-[46px] sm:left-46 rounded-r-md"
          : "left-[28px] sm:left-46",
      )}
      style={{
  ...
  return (
    ...
    >
      ...
      >
        <p
          className={classNames(
            "driver-card-position text-2xl font-display px-8 py-4 bg-neutral-700 rounded-l-md flex items-center",
          )}
        >
          P{isRace ? endPosition : index + 1}
        </p>
        ...
        <div className="grow py-4 px-12 max-sm:px-6 text-right">
          <span className="heading-4 mb-12 pl-60 max-sm:pl-34">
            {driver.code}
          </span>
