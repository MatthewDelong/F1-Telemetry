...
const ArSection = ({ layoutMobile }) => {
    ...
    return (
        <section
            ref={sectionRef}
            className="min-h-screen snap-start flex items-center justify-center px-16 bg-neutral-950 relative overflow-x-hidden"
        >
            <div className="max-w-screen-lg mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <p className="mb-24"><span className="font-bold">Capture stunning moments. </span>With our AR feature, snap breathtaking photos and videos of your F1 car in various settings. Share these moments with friends and fellow enthusiasts, and don’t forget to tag @f1telemetry! #f1telemetry</p>
                        <img
                            className="w-1/3"
                            src={`${
                                "/images/arQr.png"
