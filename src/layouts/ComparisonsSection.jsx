...
const ComparisonsSection = ({ layoutMobile, container }) => {
      ...
      <div className={classNames(customClassName, "z-[11] px-0")}>
          ...
          onClick={() => {
            ...
            if (typeof window.trackButtonClick === "function") {
              window.trackButtonClick(
                `Home/Click/Section/Comparisons - /driver-comparison`,
              );
            }
          }}
          size="sm"
        ...
        <Button
          ...
          onClick={() => {
            ...
            if (typeof window.trackButtonClick === "function") {
              window.trackButtonClick(
                `Home/Click/Section/Comparisons - /teammates-comparison`,
              );
            }
          }}
          size="sm"
  ...
  return (
    ...
    >
      ...
      {/* Comparison Grid */}
      <motion.div className="comparison-container relative" ref={sectionRef}>
